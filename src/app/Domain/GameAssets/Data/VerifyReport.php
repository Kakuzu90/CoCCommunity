...
/** Result of auditing a published pack against its committed manifest (specs/10 §9, §11.2). */
final readonly class VerifyReport
{
     ...
     * @param  list<string>  $extra  bucket objects under the version prefix not in the manifest
     */
