@props(['name', 'size' => 20])
@php
    if (! in_array($name, ['check', 'close', 'plus', 'chevron', 'arrow', 'info', 'star', 'shield', 'layers', 'search', 'spinner', 'heart'], true)) throw new InvalidArgumentException('Unknown platform icon.');
@endphp
